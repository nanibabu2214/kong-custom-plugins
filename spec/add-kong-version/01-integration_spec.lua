...
local PLUGIN_NAME = "add-kong-version"
  ...
  describe(PLUGIN_NAME .. ": [#" .. strategy .. "]", function()
    ...
    describe("The response", function()
      ...
      it("gets the expected header", function()
        ...
        local header_value = assert.response(r).has.header("X-#%#%#%#%#%#%#-Custom-Header")

        -- validate the value of that header
        assert.equal("THIS IS ADDED BY CUSTOM PLUGIN", header_value)
